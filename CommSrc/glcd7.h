...
#define C_GLCD_H_PULSE          4	// 2
#define C_GLCD_H_FRONT_PORCH    40	// 5
#define C_GLCD_H_BACK_PORCH     88 	// 40
#define C_GLCD_V_SIZE           480
#define C_GLCD_V_PULSE          3	// 2
#define C_GLCD_V_FRONT_PORCH    13	// 8
#define C_GLCD_V_BACK_PORCH     32	// 8
