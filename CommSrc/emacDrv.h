#ifndef __LPC177X_8X_EMAC_H__
#define __LPC177X_8X_EMAC_H__

#include "LPC177x_8x.h"
#include "typeDef.h"
#include "net_def.h"

#define USING_LPC_ETH	1
...
#define EMAC_NUM_RX_FRAG         17			// Num.of RX Fragments 17*256 = 4352 Bytes
#define EMAC_NUM_TX_FRAG         13			// Num.of TX Fragments 13*256 = 3328 Bytes
#define EMAC_ETH_FRAG_SIZE       256		// Packet Fragment size 256 Bytes
#define EMAC_ETH_MAX_FLEN        1536		// Max. Ethernet Frame Size
#define EMAC_TX_FRAME_TOUT       0x00100000	// Frame Transmit timeout count

/* EMAC variables located in 16K Ethernet SRAM */
#define RX_DESC_BASE	Rx_Desc
 ...
 */
#define RX_STAT_INFO(i)     (*(uint32_t *)(Rx_Desc[i]))
...
typedef struct {
	...
	byte netState;	// IF_UP or IF_DOWN (power state)
	byte hwa[6];	// Shadow copy of current MAC address
	U32 num_tx, num_rx;

} _LPC_Eth_Conf;
// netState bit define
// bit0: IF_DOWN(0)/IF_UP(1)
// bit1: NOT LINK(0)/LINK ON(1)
#define NET_STATE_IF_UP_DOWN (0x01<<0)
#define NET_STATE_LINK_STATE (0x01<<1)	// 0 = not link, 1 = link
#define NET_STATE_SPD_STATE (0x01<<2)	// 0 = 10M, 1 = 100M
#define NET_STATE_DUP_STATE (0x01<<3)	// 0 = HDX, 1 = FDX
#define NET_STATE_INIT_SUCC  (0x01<<7)

extern const NetControllerDevice LPC_Eth_Controller;
extern _LPC_Eth_Conf LPC_Eth_Conf[USING_LPC_ETH];
#define LPC_MAC_TABLE  { &LPC_Eth_Controller, (void *)LPC_Eth_Conf, 0, 0 },

#endif /* __LPC177X_8X_EMAC_H__ */
